...
if __name__ == "__main__":
    model = poincare_mean(1, False, False)

    model.train()
    depth = torch.randn(5, 576)
    input = torch.randn(5, 512, 8, 8)
    ...
    print(out.shape)
    out1 = input
    print("input is equal out", input.equal(out))
    print("input is equal out1", input.equal(out1))